...
echo -e '3、本地资源开始压缩'
# gtar -czf yice-performance.tar.gz dist pm2/config.* static/README.md website/dist scripts/start.sh package.json pnpm-lock.yaml .env
gtar -czf yice-performance.tar.gz dist pm2/config.* static/README.md website/dist scripts/start.sh package.json pnpm-lock.yaml
