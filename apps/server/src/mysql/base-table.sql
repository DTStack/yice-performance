CREATE DATABASE IF NOT EXISTS `yice-performance` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yice-performance`;
...
CREATE TABLE `project` (
  ...
  `appName` varchar(64) NULL COMMENT '项目路径/标识',
  `emails` varchar(256) NULL COMMENT '子产品相关人员邮箱，用于接收数据周报邮件',
...
CREATE TABLE `version` (
  ...
  `sort` int NULL DEFAULT 1 COMMENT '排序序号',
